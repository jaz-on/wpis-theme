...
| Setup / seed       | [inc/theme-setup.php](../inc/theme-setup.php), [inc/wpis-cli-seed.php](../inc/wpis-cli-seed.php), [inc/admin-seed.php](../inc/admin-seed.php) | manifest pages, lecture statique, `wp wpis-seed` ou écran admin                                                                                                      | Démo (DB)                                         | **Pas** d’accroche activation ; nav FSE dans [parts/header.html](../parts/header.html)                 |
...
| Parts              | [parts/header.html](../parts/header.html), [footer.html](../parts/footer.html), [quote-feed-card.html](../parts/quote-feed-card.html)           | en-tête (`core/navigation` + liens), pied, fragment carte                                                                                                            | FSE                                               | pas d’emplacement menu classique                                                                        |
...
- [parts/header.html](../parts/header.html) : bloc Navigation avec `navigation-link` (pas de `register_nav_menus`).
